...
echo "Sprites"
#./spriteconv.py galaga_sprites galaga ../roms/c1.5h ../roms/c2.5f ../galagino/galaga_spritemap.h
...
#./spriteconv.py dkong_sprites dkong ../roms/c1.5h ../roms/c2.5f  ../galagino/dkong_spritemap.h
